...
def main():
    ...
    output_file_path = 'labels_distribution_by_annotation.json'
...
directory_path = ['./TernsTags/images_to_tag(Rotem)/02_06_1000',\
                    './TernsTags/images_to_tag(Rotem)/02_06_1000']